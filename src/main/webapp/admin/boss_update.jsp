...
<body bgcolor='white'>
	<table id="table-1">
		<tr>
			<td>
				<h3>老闆編輯員工資料 - boss_update.jsp</h3>
				<h4>
	...
	<FORM METHOD="post" ACTION="/molife/adminController" name="boss_Update"
		...
		<table>
			...
			<tr>
				<td>員工權限:</td>
				<td><input type="TEXT" name="empAuthId" size="45"
					value="<%=(adminVO == null) ? "" : adminVO.getEmpAuthId()%>" /></td>
			</tr>
			<tr>
				<td>員工狀態:</td>
				<td><input type="TEXT" name="empStatus" size="45"
					value="<%=(adminVO == null) ? "" : adminVO.getEmpStatus()%>" /></td>
			</tr>
		...
		<br> <input type="hidden" name="action" value="updatebyBoss">
